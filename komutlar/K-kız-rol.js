...
.setColor(0x36393F)
.setDescription(`<a:onaylamak:825688895286280232> Sunucu için ayarladığınız kız rolü başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<a:reddetmek:825688868107059201> Ayarlayacağınız kız rolünü belirtiniz!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Darkwill`)
...
.setTitle(`${client.user.username} | Kız rol ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<a:onaylamak:825688895286280232> Kız rolü başarıyla ${rol} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Darkwill`)
